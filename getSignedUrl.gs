var AWS_KEY = 'AKIATXHFEQZHKW470000'; //Get from AWS
var AWS_SECRET = 'hxNYEXV78rtsazxC2pzvbeT2mDw8OXbGEqZ7nCJ'; //Get from AWS
var REGION = 'eu-west-1'; // region where your bucket is located
 ...
 * @customfunction
 */
function getUrlFileList(bucket, path) {
